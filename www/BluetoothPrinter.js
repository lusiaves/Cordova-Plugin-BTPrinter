...
var BTPrinter = {
    ...
    printBase64: function (fnSuccess, fnError, str, align,MaxPrintableDotsPerLine) {
        exec(fnSuccess, fnError, "BluetoothPrinter", "printBase64", [str, align, MaxPrintableDotsPerLine]);
    },
